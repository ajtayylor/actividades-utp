...
$rol = $_SESSION['rol'] ?? 'Usuario'; // Por defecto, se asume "Usuario" si no está definido
...
$categoria = 'Deportes'; // Valor seguro
            ...
            <ul>
                ...
                <li class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <?php
                        if ($rol === 'Organizador') {
                            echo '<a href="deportes.php">Deportes</a>';
                            echo '<a href="otros.php">Otros</a>';
                        } else {
                            echo '<a href="deportes.php">Deportes</a>';
                            echo '<a href="otros.php">Otros</a>';
                        }
    ...
    <section class="sport-section">
        ...
        if ($resultadoClubes->num_rows > 0) {
            while ($club = $resultadoClubes->fetch_assoc()) {
                ...
                // Dentro del while que recorre los clubes
                ...
                echo '<h2>Club de ' . $club['nombre'] . '</h2>';
                    ...
                    // Formulario para inscribirse al club
                echo '<form method="POST" action="unirse_club.php">';
                echo '<input type="hidden" name="correo" value="' . $_SESSION['correo'] . '">'; // Correo del usuario
                echo '<input type="hidden" name="nombre" value="' . $club['nombre'] . '">'; // Nombre del club
                echo '<button type="submit" class="button">Inscribir</button>';
                echo '</form>'; // Cerrar el formulario

                echo '</div>'; // Cerrar el div de sport-info
                echo '</div>'; // Cerrar el div de sport-card
    }
} else {
    echo "<p>No se encontraron clubes en la categoría 'Deportes'.</p>";
      }
      ?>
    </section>
    <!-- Footer -->
